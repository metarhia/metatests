...
const PATH_TO_GET_TIME = __dirname + '/speed/get-time.js';
const PATH_TO_GET_NODE_PATH = __dirname + '/speed/get-node-path.sh';

const DEFAULT_COUNT = 10000;
const DEFAULT_PERCENT = 10000;
...
const speed = (
  ...
  const MAX_ANOMALY_PERCENT = parameters.MAX_ANOMALY_PERCENT || DEFAULT_PERCENT;
